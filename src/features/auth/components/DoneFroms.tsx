...
export function DoneForm() {
  ...
  return (
    <section className='flex flex-col justify-center items-center py-[60px] px-[10px] bg-white dark:bg-dark-secondary text-center  rounded-2xl w-[40%] mx-auto mt-[100px]'>
