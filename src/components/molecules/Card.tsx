...
const Card: React.FC<CourseCardProps> = ({ course, className = "" }) => {
  ...
  return (
    <div
      className={`group rounded-2xl dark:bg-dark-secondary shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden max-w-sm mx-auto transform hover:-translate-y-1 ${classes} ${className}`}
    >
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex items-start justify-between mx-7">
          <span
            className={`py-2 px-5 text-md font-medium ${t(
