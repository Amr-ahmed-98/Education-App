 ...
 variant,
    ...
    return(
      ...
      <div >
        ...
        <h1 className="mb-6 mt-[10px] text-b text-[48px] leading-[70px]"><span className="text-primary">{subtitle1}</span> {subtitle2} <span className="text-secondary">{subtitle3} </span></h1>
