...
import { Blog1 } from "@/assets/images/Blog";
...
function Blogs() {
  ...
  return (
    <div className="w-full flex flex-col gap-50 pt-0 ">
      {/* <Test /> */}

      {/* Section 1 */}
      <div className="flex flex-col justify-center items-center text-center gap-10 pt-0 mt-10">
        <h1 className="font-extrabold  text-[60px] leading-[75px] tracking-[-1.5px] text-center ">
        ...
        <img src={Blog1} alt="Blog1" className="rounded-lg" />
      </div>
      {/* Section 2 */}
